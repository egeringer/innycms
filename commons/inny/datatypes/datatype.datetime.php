...
class InnyType_Datetime extends InnyType_Text {
    ...
    static function validateDate($date, $format = 'Y-m-d H:i'){
    ...
    public function validate($value = null){
        ...
        if($multilang){
            ...
            foreach($languages as $key => $lang){
                //Replace for browsers that support datetime-local
                $values[$key] = str_replace("T"," ",$vals[$key]);
            }
    ...
    public function htmlInput(){
        ...
        $additionalParams = "placeholder='YYYY-MM-DD HH:MM'";
