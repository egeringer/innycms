            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item"><a href="./bucket?id={$smarty.get.id}&action=view" class="m-nav__link"><span class="m-nav__link-text">{'View'|_t} {$daoBucket->name}</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-12">
                                ...
                                {if $usages}
                                    <b>{"Usages"|_t}:</b>
                                    <ul>
                                        {foreach $usages as $collection => $items}
                                            {foreach $items as $key => $value}
                                                <li><a href="{collectionURL($collection,'view',$key)}">{collectionURL($collection,'view',$key)}</a></li>
                                            {/foreach}
                                        {/foreach}
                                    </ul>
                                {/if}
